...
*/
func (a *Client) DeleteLimitsID(params *DeleteLimitsIDParams) (*DeleteLimitsIDOK, *DeleteLimitsIDNoContent, error) {
	...
	case *DeleteLimitsIDOK:
		return value, nil, nil
	case *DeleteLimitsIDNoContent:
