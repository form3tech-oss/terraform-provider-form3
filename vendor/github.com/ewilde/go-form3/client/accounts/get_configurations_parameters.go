...
// WithPageNumber adds the pageNumber to the get configurations params
func (o *GetConfigurationsParams) WithPageNumber(pageNumber *int64) *GetConfigurationsParams {
	o.SetPageNumber(pageNumber)
	return o
}

// SetPageNumber adds the pageNumber to the get configurations params
func (o *GetConfigurationsParams) SetPageNumber(pageNumber *int64) {
	o.PageNumber = pageNumber
}

// WithPageSize adds the pageSize to the get configurations params
func (o *GetConfigurationsParams) WithPageSize(pageSize *int64) *GetConfigurationsParams {
	o.SetPageSize(pageSize)
	return o
}

// SetPageSize adds the pageSize to the get configurations params
func (o *GetConfigurationsParams) SetPageSize(pageSize *int64) {
	o.PageSize = pageSize
}
