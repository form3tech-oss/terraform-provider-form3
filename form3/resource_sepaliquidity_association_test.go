...
func TestAccSepaLiquidityAssociation_basic(t *testing.T) {
	...
	sponsorAssociationTechnicalBic := fmt.Sprintf("%s%d", randBicPrefix(6), randomNumber(20, 99))
	sponsorAssociationSettlementBic := fmt.Sprintf("%s%d", randBicPrefix(6), randomNumber(20, 99))
	sponsorAssociationSettlementIban := generateRandomIban()
	sponsoredAssociationSponsoredBic0 := fmt.Sprintf("%s%d", randBicPrefix(6), randomNumber(20000, 99999))
	sponsoredAssociationSponsoredBic1 := fmt.Sprintf("%s%d", randBicPrefix(6), randomNumber(20000, 99999))
