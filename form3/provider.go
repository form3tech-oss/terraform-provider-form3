...
func Provider() terraform.ResourceProvider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"form3_vocalink_report_certificate_request": resourceForm3VocalinkReportCertificateRequest(),
			"form3_vocalink_report_certificate":         resourceForm3VocalinkReportCertificate(),
		},
