...
func TestAccBacsAssociation_basic(t *testing.T) {
	...
	configData := associationConfigWithCerts{
		...
		InputKeyID:      uuid.NewV4().String(),
		InputCertID:     uuid.NewV4().String(),
		MessagingKeyID:  uuid.NewV4().String(),
		MessagingCertID: uuid.NewV4().String(),
		OutputKeyID:     uuid.NewV4().String(),
		OutputCertID:    uuid.NewV4().String(),
	}
