...
func TestAccSepaReconciliationAssociation_basic(t *testing.T) {
	...
	sponsorAssociationReconciliationBic := fmt.Sprintf("BICBIC%d", randomNumber(20, 99))
	sponsorAssociationReconciliationIban := generateRandomIban()
	sponsoredAssociationTechnicalBic := fmt.Sprintf("BICBIC%d", randomNumber(20, 99))
	sponsoredAssociationReconciliationBic := fmt.Sprintf("BICBIC%d", randomNumber(20, 99))
