...
type ClientService interface {
	GetMandates(params *GetMandatesParams, opts ...ClientOption) (*GetMandatesOK, error)
...
*/
func (a *Client) GetMandates(params *GetMandatesParams, opts ...ClientOption) (*GetMandatesOK, error) {
