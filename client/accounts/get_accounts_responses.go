...
/* GetAccountsConflict describes a response with status code 409, with default header values.
...
/* GetAccountsServiceUnavailable describes a response with status code 503, with default header values.
