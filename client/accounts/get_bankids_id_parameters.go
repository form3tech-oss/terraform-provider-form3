...
/* GetBankidsIDParams contains all the parameters to send to the API endpoint
   for the get bankids ID operation.
...
// WithDefaults hydrates default values in the get bankids ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetBankidsIDParams) WithDefaults() *GetBankidsIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get bankids ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetBankidsIDParams) SetDefaults() {
