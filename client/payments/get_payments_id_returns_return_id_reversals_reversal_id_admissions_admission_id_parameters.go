...
/* GetPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsAdmissionIDParams contains all the parameters to send to the API endpoint
   for the get payments ID returns return ID reversals reversal ID admissions admission ID operation.
...
// WithDefaults hydrates default values in the get payments ID returns return ID reversals reversal ID admissions admission ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsAdmissionIDParams) WithDefaults() *GetPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsAdmissionIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get payments ID returns return ID reversals reversal ID admissions admission ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetPaymentsIDReturnsReturnIDReversalsReversalIDAdmissionsAdmissionIDParams) SetDefaults() {
