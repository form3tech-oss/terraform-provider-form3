...
/* PostPaymentsIDReversalsParams contains all the parameters to send to the API endpoint
   for the post payments ID reversals operation.
...
// WithDefaults hydrates default values in the post payments ID reversals params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostPaymentsIDReversalsParams) WithDefaults() *PostPaymentsIDReversalsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the post payments ID reversals params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PostPaymentsIDReversalsParams) SetDefaults() {
