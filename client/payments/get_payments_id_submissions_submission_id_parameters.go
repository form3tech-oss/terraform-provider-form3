...
/* GetPaymentsIDSubmissionsSubmissionIDParams contains all the parameters to send to the API endpoint
   for the get payments ID submissions submission ID operation.
...
// WithDefaults hydrates default values in the get payments ID submissions submission ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetPaymentsIDSubmissionsSubmissionIDParams) WithDefaults() *GetPaymentsIDSubmissionsSubmissionIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get payments ID submissions submission ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetPaymentsIDSubmissionsSubmissionIDParams) SetDefaults() {
