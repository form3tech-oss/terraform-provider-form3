...
// NewGetUnitsIDParams creates a new GetUnitsIDParams object,
...
func NewGetUnitsIDParams() *GetUnitsIDParams {
	return &GetUnitsIDParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetUnitsIDParamsWithTimeout creates a new GetUnitsIDParams object
...
// NewGetUnitsIDParamsWithContext creates a new GetUnitsIDParams object
...
// NewGetUnitsIDParamsWithHTTPClient creates a new GetUnitsIDParams object
...
/* GetUnitsIDParams contains all the parameters to send to the API endpoint
   for the get units ID operation.
...
// WithDefaults hydrates default values in the get units ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetUnitsIDParams) WithDefaults() *GetUnitsIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get units ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetUnitsIDParams) SetDefaults() {
