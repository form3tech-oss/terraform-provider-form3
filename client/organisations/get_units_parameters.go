...
// WithDefaults hydrates default values in the get units params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetUnitsParams) WithDefaults() *GetUnitsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get units params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetUnitsParams) SetDefaults() {
