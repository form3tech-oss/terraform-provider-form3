...
/* DeleteSepainstantIDParams contains all the parameters to send to the API endpoint
   for the delete sepainstant ID operation.
...
// WithDefaults hydrates default values in the delete sepainstant ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSepainstantIDParams) WithDefaults() *DeleteSepainstantIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the delete sepainstant ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *DeleteSepainstantIDParams) SetDefaults() {
