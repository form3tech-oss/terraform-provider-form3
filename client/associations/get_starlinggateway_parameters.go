...
// NewGetStarlinggatewayParams creates a new GetStarlinggatewayParams object
// with the default values initialized.
func NewGetStarlinggatewayParams() *GetStarlinggatewayParams {
	var ()
	return &GetStarlinggatewayParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetStarlinggatewayParamsWithTimeout creates a new GetStarlinggatewayParams object
...
// NewGetStarlinggatewayParamsWithContext creates a new GetStarlinggatewayParams object
...
// NewGetStarlinggatewayParamsWithHTTPClient creates a new GetStarlinggatewayParams object
...
/*GetStarlinggatewayParams contains all the parameters to send to the API endpoint
for the get starlinggateway operation typically these are written to a http.Request
*/
