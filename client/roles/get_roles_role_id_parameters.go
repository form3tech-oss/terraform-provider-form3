...
/* GetRolesRoleIDParams contains all the parameters to send to the API endpoint
   for the get roles role ID operation.
...
// WithDefaults hydrates default values in the get roles role ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetRolesRoleIDParams) WithDefaults() *GetRolesRoleIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get roles role ID params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetRolesRoleIDParams) SetDefaults() {
