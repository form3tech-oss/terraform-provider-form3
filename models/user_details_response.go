...
// ContextValidate validate this user details response based on the context it is used
func (m *UserDetailsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UserDetailsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserDetailsResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
