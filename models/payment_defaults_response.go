...
// ContextValidate validate this payment defaults response based on the context it is used
func (m *PaymentDefaultsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentDefaultsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
