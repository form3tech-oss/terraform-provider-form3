...
// ContextValidate validates this vocalink report association attributes based on context it is used
func (m *VocalinkReportAssociationAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
