...
// ContextValidate validate this new return submission based on the context it is used
func (m *NewReturnSubmission) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NewReturnSubmission) contextValidateRelationships(ctx context.Context, formats strfmt.Registry) error {
