...
func (m *LhvMasterAccountCreation) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this lhv master account creation based on the context it is used
func (m *LhvMasterAccountCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LhvMasterAccountCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LhvMasterAccountCreation) UnmarshalBinary(b []byte) error {
	var res LhvMasterAccountCreation
