...
// ContextValidate validates this signing keys attributes based on context it is used
func (m *SigningKeysAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
