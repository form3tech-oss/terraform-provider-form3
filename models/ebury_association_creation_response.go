...
func (m *EburyAssociationCreationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EburyAssociationCreationResponse) validateData(formats strfmt.Registry) error {
...
func (m *EburyAssociationCreationResponse) UnmarshalBinary(b []byte) error {
	var res EburyAssociationCreationResponse
