...
func (m *ReturnAdmissionCreation) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this return admission creation based on the context it is used
func (m *ReturnAdmissionCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnAdmissionCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnAdmissionCreation) UnmarshalBinary(b []byte) error {
	var res ReturnAdmissionCreation
