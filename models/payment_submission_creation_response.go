...
// ContextValidate validate this payment submission creation response based on the context it is used
func (m *PaymentSubmissionCreationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentSubmissionCreationResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PaymentSubmissionCreationResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
