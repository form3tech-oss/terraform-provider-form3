...
// ContextValidate validates this credential secret based on context it is used
func (m *CredentialSecret) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
