...
func (m *NewSepaReconciliationAssociation) validateVersion(formats strfmt.Registry) error {
...
// ContextValidate validate this new sepa reconciliation association based on the context it is used
func (m *NewSepaReconciliationAssociation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NewSepaReconciliationAssociation) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NewSepaReconciliationAssociation) contextValidateRelationships(ctx context.Context, formats strfmt.Registry) error {
