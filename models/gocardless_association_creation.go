...
func (m *GocardlessAssociationCreation) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this gocardless association creation based on the context it is used
func (m *GocardlessAssociationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GocardlessAssociationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GocardlessAssociationCreation) UnmarshalBinary(b []byte) error {
	var res GocardlessAssociationCreation
