...
func (m *AccountConfigurationCreation) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this account configuration creation based on the context it is used
func (m *AccountConfigurationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AccountConfigurationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccountConfigurationCreation) UnmarshalBinary(b []byte) error {
	var res AccountConfigurationCreation
