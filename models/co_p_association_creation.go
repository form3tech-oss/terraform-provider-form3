...
// ContextValidate validate this co p association creation based on the context it is used
func (m *CoPAssociationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CoPAssociationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CoPAssociationCreation) UnmarshalBinary(b []byte) error {
	var res CoPAssociationCreation
