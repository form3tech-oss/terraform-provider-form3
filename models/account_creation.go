...
// ContextValidate validate this account creation based on the context it is used
func (m *AccountCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AccountCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
