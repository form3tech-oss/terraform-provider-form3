...
func (m *SepaDDAssociationUpdate) validateAttributes(formats strfmt.Registry) error {
...
func (m *SepaDDAssociationUpdate) validateID(formats strfmt.Registry) error {
...
func (m *SepaDDAssociationUpdate) validateOrganisationID(formats strfmt.Registry) error {
...
func (m *SepaDDAssociationUpdate) validateVersion(formats strfmt.Registry) error {
...
func (m *SepaDDAssociationUpdate) UnmarshalBinary(b []byte) error {
	var res SepaDDAssociationUpdate
