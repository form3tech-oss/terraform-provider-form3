...
// ContextValidate validate this charges information based on the context it is used
func (m *ChargesInformation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

	if err := m.contextValidateSenderCharges(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ChargesInformation) contextValidateSenderCharges(ctx context.Context, formats strfmt.Registry) error {

	for i := 0; i < len(m.SenderCharges); i++ {

		if m.SenderCharges[i] != nil {
			if err := m.SenderCharges[i].ContextValidate(ctx, formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("sender_charges" + "." + strconv.Itoa(i))
				}
				return err
...
// ContextValidate validates this charges information sender charges items0 based on context it is used
func (m *ChargesInformationSenderChargesItems0) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
