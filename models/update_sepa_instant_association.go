...
func (m *UpdateSepaInstantAssociation) validateAttributes(formats strfmt.Registry) error {
...
func (m *UpdateSepaInstantAssociation) validateID(formats strfmt.Registry) error {
...
func (m *UpdateSepaInstantAssociation) validateOrganisationID(formats strfmt.Registry) error {
...
var updateSepaInstantAssociationTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		updateSepaInstantAssociationTypeTypePropEnum = append(updateSepaInstantAssociationTypeTypePropEnum, v)
	}
}
...
func (m *UpdateSepaInstantAssociation) UnmarshalBinary(b []byte) error {
	var res UpdateSepaInstantAssociation
