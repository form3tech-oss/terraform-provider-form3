...
// ContextValidate validate this gocardless association response based on the context it is used
func (m *GocardlessAssociationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GocardlessAssociationResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
