...
func (m *PayportAssociationCreation) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this payport association creation based on the context it is used
func (m *PayportAssociationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PayportAssociationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PayportAssociationCreation) UnmarshalBinary(b []byte) error {
	var res PayportAssociationCreation
