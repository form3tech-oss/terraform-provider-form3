...
// ContextValidate validate this return creation based on the context it is used
func (m *ReturnCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
