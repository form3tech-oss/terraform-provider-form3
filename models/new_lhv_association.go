...
// ContextValidate validate this new lhv association based on the context it is used
func (m *NewLhvAssociation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NewLhvAssociation) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
