...
// ContextValidate validate this user creation based on the context it is used
func (m *UserCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UserCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
