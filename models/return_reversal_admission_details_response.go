...
// ContextValidate validate this return reversal admission details response based on the context it is used
func (m *ReturnReversalAdmissionDetailsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnReversalAdmissionDetailsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnReversalAdmissionDetailsResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
