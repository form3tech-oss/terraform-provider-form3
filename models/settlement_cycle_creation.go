...
// ContextValidate validate this settlement cycle creation based on the context it is used
func (m *SettlementCycleCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SettlementCycleCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
