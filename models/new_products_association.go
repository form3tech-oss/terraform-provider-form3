...
// ContextValidate validate this new products association based on the context it is used
func (m *NewProductsAssociation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NewProductsAssociation) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
