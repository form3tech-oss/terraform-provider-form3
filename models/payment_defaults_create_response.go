...
// ContextValidate validate this payment defaults create response based on the context it is used
func (m *PaymentDefaultsCreateResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentDefaultsCreateResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
