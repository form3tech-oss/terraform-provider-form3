...
// ContextValidate validate this sepa d d association patch based on the context it is used
func (m *SepaDDAssociationPatch) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SepaDDAssociationPatch) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
