...
// ContextValidate validate this return reversal admission creation based on the context it is used
func (m *ReturnReversalAdmissionCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnReversalAdmissionCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
