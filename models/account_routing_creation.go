...
// ContextValidate validate this account routing creation based on the context it is used
func (m *AccountRoutingCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AccountRoutingCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
