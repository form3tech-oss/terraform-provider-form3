...
// ContextValidate validate this bacs association creation based on the context it is used
func (m *BacsAssociationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BacsAssociationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
