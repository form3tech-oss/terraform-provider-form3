...
func (m *EburyAssociationAccountCreationResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EburyAssociationAccountCreationResponse) validateData(formats strfmt.Registry) error {
...
func (m *EburyAssociationAccountCreationResponse) UnmarshalBinary(b []byte) error {
	var res EburyAssociationAccountCreationResponse
