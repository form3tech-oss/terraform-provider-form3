...
func (m *EburyAssociationAccount) validateAttributes(formats strfmt.Registry) error {
...
func (m *EburyAssociationAccount) validateID(formats strfmt.Registry) error {
...
func (m *EburyAssociationAccount) validateOrganisationID(formats strfmt.Registry) error {
...
func (m *EburyAssociationAccount) validateVersion(formats strfmt.Registry) error {
...
func (m *EburyAssociationAccount) UnmarshalBinary(b []byte) error {
	var res EburyAssociationAccount
