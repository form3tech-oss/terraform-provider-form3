...
func (m *EburyAssociationAccountAttributes) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EburyAssociationAccountAttributes) validateAccountWith(formats strfmt.Registry) error {
...
func (m *EburyAssociationAccountAttributes) UnmarshalBinary(b []byte) error {
	var res EburyAssociationAccountAttributes
...
func (m *EburyAssociationAccountAttributesAccountWith) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *EburyAssociationAccountAttributesAccountWith) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *EburyAssociationAccountAttributesAccountWith) UnmarshalBinary(b []byte) error {
	var res EburyAssociationAccountAttributesAccountWith
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
