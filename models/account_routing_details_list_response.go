...
// ContextValidate validate this account routing details list response based on the context it is used
func (m *AccountRoutingDetailsListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AccountRoutingDetailsListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccountRoutingDetailsListResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
