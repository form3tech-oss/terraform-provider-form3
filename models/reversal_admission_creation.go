...
// ContextValidate validate this reversal admission creation based on the context it is used
func (m *ReversalAdmissionCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReversalAdmissionCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
