...
// ContextValidate validate this reversal creation based on the context it is used
func (m *ReversalCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReversalCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
