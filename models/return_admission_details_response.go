...
// ContextValidate validate this return admission details response based on the context it is used
func (m *ReturnAdmissionDetailsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnAdmissionDetailsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnAdmissionDetailsResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
