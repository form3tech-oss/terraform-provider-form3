...
// ContextValidate validates this new association attributes based on context it is used
func (m *NewAssociationAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
