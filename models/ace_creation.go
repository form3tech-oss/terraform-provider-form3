...
// ContextValidate validate this ace creation based on the context it is used
func (m *AceCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AceCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
