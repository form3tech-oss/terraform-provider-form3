...
// ContextValidate validate this sepact liquidity association update based on the context it is used
func (m *SepactLiquidityAssociationUpdate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SepactLiquidityAssociationUpdate) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
