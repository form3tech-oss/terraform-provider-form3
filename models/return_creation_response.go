...
// ContextValidate validate this return creation response based on the context it is used
func (m *ReturnCreationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnCreationResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnCreationResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
