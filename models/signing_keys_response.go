...
// ContextValidate validate this signing keys response based on the context it is used
func (m *SigningKeysResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SigningKeysResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
