...
// ContextValidate validates this sepa instant association attributes based on context it is used
func (m *SepaInstantAssociationAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
