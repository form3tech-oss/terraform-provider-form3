...
// ContextValidate validate this account details list response based on the context it is used
func (m *AccountDetailsListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AccountDetailsListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccountDetailsListResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
