...
// ContextValidate validate this organisation based on the context it is used
func (m *Organisation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *Organisation) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
