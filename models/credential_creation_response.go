...
func (m *CredentialCreationResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CredentialCreationResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
