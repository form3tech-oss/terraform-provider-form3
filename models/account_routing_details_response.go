...
// ContextValidate validate this account routing details response based on the context it is used
func (m *AccountRoutingDetailsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AccountRoutingDetailsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *AccountRoutingDetailsResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
