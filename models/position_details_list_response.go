...
// ContextValidate validate this position details list response based on the context it is used
func (m *PositionDetailsListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PositionDetailsListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
