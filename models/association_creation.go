...
// ContextValidate validate this association creation based on the context it is used
func (m *AssociationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *AssociationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
