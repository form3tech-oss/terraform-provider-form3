...
func (m *PaymentDefaultsCreate) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this payment defaults create based on the context it is used
func (m *PaymentDefaultsCreate) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentDefaultsCreate) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
