...
// ContextValidate validate this organisation creation response based on the context it is used
func (m *OrganisationCreationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OrganisationCreationResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrganisationCreationResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
