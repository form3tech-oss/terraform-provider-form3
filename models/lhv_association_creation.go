...
func (m *LhvAssociationCreation) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this lhv association creation based on the context it is used
func (m *LhvAssociationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LhvAssociationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LhvAssociationCreation) UnmarshalBinary(b []byte) error {
	var res LhvAssociationCreation
