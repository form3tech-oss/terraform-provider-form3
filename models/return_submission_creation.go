...
// ContextValidate validate this return submission creation based on the context it is used
func (m *ReturnSubmissionCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnSubmissionCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
