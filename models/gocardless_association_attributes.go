...
// ContextValidate validates this gocardless association attributes based on context it is used
func (m *GocardlessAssociationAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
