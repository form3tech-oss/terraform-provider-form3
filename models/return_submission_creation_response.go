...
// ContextValidate validate this return submission creation response based on the context it is used
func (m *ReturnSubmissionCreationResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnSubmissionCreationResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnSubmissionCreationResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
