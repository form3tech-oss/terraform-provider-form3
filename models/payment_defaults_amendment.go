...
func (m *PaymentDefaultsAmendment) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this payment defaults amendment based on the context it is used
func (m *PaymentDefaultsAmendment) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentDefaultsAmendment) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PaymentDefaultsAmendment) UnmarshalBinary(b []byte) error {
	var res PaymentDefaultsAmendment
