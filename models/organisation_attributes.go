...
// ContextValidate validates this organisation attributes based on context it is used
func (m *OrganisationAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
