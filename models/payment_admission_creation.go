...
// ContextValidate validate this payment admission creation based on the context it is used
func (m *PaymentAdmissionCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentAdmissionCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
