...
// ContextValidate validate this gocardless association amendment based on the context it is used
func (m *GocardlessAssociationAmendment) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GocardlessAssociationAmendment) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
