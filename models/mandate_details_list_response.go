...
// ContextValidate validate this mandate details list response based on the context it is used
func (m *MandateDetailsListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MandateDetailsListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MandateDetailsListResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
