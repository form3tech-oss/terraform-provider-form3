...
// ContextValidate validate this return submission relationships based on the context it is used
func (m *ReturnSubmissionRelationships) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnSubmissionRelationships) contextValidatePaymentReturn(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnSubmissionRelationships) contextValidateValidations(ctx context.Context, formats strfmt.Registry) error {
