...
// ContextValidate validate this beneficiary debtor account holding entity based on the context it is used
func (m *BeneficiaryDebtorAccountHoldingEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BeneficiaryDebtorAccountHoldingEntity) contextValidateBankIDCode(ctx context.Context, formats strfmt.Registry) error {
