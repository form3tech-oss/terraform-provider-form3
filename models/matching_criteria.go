...
// ContextValidate validates this matching criteria based on context it is used
func (m *MatchingCriteria) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
