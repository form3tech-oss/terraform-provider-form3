...
// ContextValidate validate this sepa liquidity association creation based on the context it is used
func (m *SepaLiquidityAssociationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SepaLiquidityAssociationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
