...
// ContextValidate validate this return admission based on the context it is used
func (m *ReturnAdmission) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnAdmission) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnAdmission) contextValidateRelationships(ctx context.Context, formats strfmt.Registry) error {
...
// ContextValidate validate this return admission attributes based on the context it is used
func (m *ReturnAdmissionAttributes) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnAdmissionAttributes) contextValidateAdmissionDatetime(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnAdmissionAttributes) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
