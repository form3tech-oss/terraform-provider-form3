...
func (m *SepaInstantAssociation) validateAttributes(formats strfmt.Registry) error {
...
func (m *SepaInstantAssociation) validateID(formats strfmt.Registry) error {
...
func (m *SepaInstantAssociation) validateOrganisationID(formats strfmt.Registry) error {
...
func (m *SepaInstantAssociation) validateVersion(formats strfmt.Registry) error {
...
// ContextValidate validate this sepa instant association based on the context it is used
func (m *SepaInstantAssociation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SepaInstantAssociation) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SepaInstantAssociation) contextValidateRelationships(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SepaInstantAssociation) UnmarshalBinary(b []byte) error {
	var res SepaInstantAssociation
