...
// ContextValidate validate this return reversal creation based on the context it is used
func (m *ReturnReversalCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnReversalCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
