...
// ContextValidate validate this payment submission amendment based on the context it is used
func (m *PaymentSubmissionAmendment) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentSubmissionAmendment) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
