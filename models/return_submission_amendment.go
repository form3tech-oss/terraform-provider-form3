...
func (m *ReturnSubmissionAmendment) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this return submission amendment based on the context it is used
func (m *ReturnSubmissionAmendment) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ReturnSubmissionAmendment) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ReturnSubmissionAmendment) UnmarshalBinary(b []byte) error {
	var res ReturnSubmissionAmendment
