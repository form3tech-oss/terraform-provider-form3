...
// ContextValidate validate this payment submission creation based on the context it is used
func (m *PaymentSubmissionCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentSubmissionCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
