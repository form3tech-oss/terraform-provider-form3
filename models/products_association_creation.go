...
func (m *ProductsAssociationCreation) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this products association creation based on the context it is used
func (m *ProductsAssociationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ProductsAssociationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ProductsAssociationCreation) UnmarshalBinary(b []byte) error {
	var res ProductsAssociationCreation
