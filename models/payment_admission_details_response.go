...
// ContextValidate validate this payment admission details response based on the context it is used
func (m *PaymentAdmissionDetailsResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentAdmissionDetailsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PaymentAdmissionDetailsResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
