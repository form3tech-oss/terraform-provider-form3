...
// ContextValidate validate this user credential list response based on the context it is used
func (m *UserCredentialListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *UserCredentialListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *UserCredentialListResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
