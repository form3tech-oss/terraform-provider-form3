...
// ContextValidate validate this payment creation based on the context it is used
func (m *PaymentCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PaymentCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
