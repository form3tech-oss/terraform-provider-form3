...
// ContextValidate validate this relationship links based on the context it is used
func (m *RelationshipLinks) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RelationshipLinks) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
