...
func (m *EburyAssociationAccountListResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EburyAssociationAccountListResponse) validateData(formats strfmt.Registry) error {
...
func (m *EburyAssociationAccountListResponse) UnmarshalBinary(b []byte) error {
	var res EburyAssociationAccountListResponse
