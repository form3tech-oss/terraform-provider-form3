...
func (m *LimitDetailsListResponse) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this limit details list response based on the context it is used
func (m *LimitDetailsListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LimitDetailsListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LimitDetailsListResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LimitDetailsListResponse) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
