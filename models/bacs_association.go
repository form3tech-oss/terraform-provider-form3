...
// ContextValidate validate this bacs association based on the context it is used
func (m *BacsAssociation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BacsAssociation) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BacsAssociation) contextValidateRelationships(ctx context.Context, formats strfmt.Registry) error {
