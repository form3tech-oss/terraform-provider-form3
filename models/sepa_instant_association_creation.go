...
// ContextValidate validate this sepa instant association creation based on the context it is used
func (m *SepaInstantAssociationCreation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SepaInstantAssociationCreation) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
