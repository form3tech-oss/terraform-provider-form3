...
// ContextValidate validate this role details list response based on the context it is used
func (m *RoleDetailsListResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RoleDetailsListResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RoleDetailsListResponse) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
