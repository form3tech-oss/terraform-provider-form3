...
func (m *Key) validateAttributes(formats strfmt.Registry) error {
...
func (m *Key) validateOrganisationID(formats strfmt.Registry) error {
...
func (m *Key) validateVersion(formats strfmt.Registry) error {
...
func (m *Key) contextValidateAttributes(ctx context.Context, formats strfmt.Registry) error {
