...
func (m *ReconciliationServiceAssociationAttributes) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ReconciliationServiceAssociationAttributes) validateBankIds(formats strfmt.Registry) error {
...
func (m *ReconciliationServiceAssociationAttributes) validateName(formats strfmt.Registry) error {
...
var reconciliationServiceAssociationAttributesTypeSchemeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		reconciliationServiceAssociationAttributesTypeSchemeTypePropEnum = append(reconciliationServiceAssociationAttributesTypeSchemeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *ReconciliationServiceAssociationAttributes) validateSchemeTypeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, reconciliationServiceAssociationAttributesTypeSchemeTypePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ReconciliationServiceAssociationAttributes) validateSchemeType(formats strfmt.Registry) error {
...
func (m *ReconciliationServiceAssociationAttributes) UnmarshalBinary(b []byte) error {
	var res ReconciliationServiceAssociationAttributes
